...
class Ishsoatlarinihisoblash {
    
    
    public function mal_kirit() {
        ...
        foreach($days as $day) {
            ...
            if ($day == "Saturday" or $day == "Sunday") {
                ...
                echo "Leaved at";
                echo "<input type='time' name='soat1_$day'>";
            }
        }
    ...
    public function hisobla_result() {
        $days=["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"];
        $results=[];
...
$ishSoatlariniHisoblash = new Ishsoatlarinihisoblash();
$ishSoatlariniHisoblash -> mal_kirit();
$ishSoatlariniHisoblash -> hisobla_result();
